class com.rockstargames.gtav.pauseMenu.pauseMenuItems.singleplayer.PauseMenuKeymapCategoryModel extends com.rockstargames.ui.components.GUIModel
{
   ...
   function createView(_viewIndex, _params)
   {
      ...
      if(_loc2_ == undefined)
      {
         _loc2_ = new com.rockstargames.gtav.pauseMenu.pauseMenuItems.singleplayer.PauseMenuKeymapCategoryView();
      }
   ...
   function removeDataFromSlot(_viewIndex, _slotIndex)
   {
      ...
      _loc2_.destroy();
      this.viewIndex = 0;
      var _loc3_ = (com.rockstargames.gtav.pauseMenu.pauseMenuItems.singleplayer.PauseMenuKeymapCategoryView)this.getCurrentView();
   }
   function nextItem()
   {
      var _loc3_ = (com.rockstargames.gtav.pauseMenu.pauseMenuItems.singleplayer.PauseMenuKeymapCategoryView)this.getCurrentView();
   ...
   function prevItem()
   {
      var _loc4_ = (com.rockstargames.gtav.pauseMenu.pauseMenuItems.singleplayer.PauseMenuKeymapCategoryView)this.getCurrentView();
      var _loc7_ = 0;
      var _loc8_ = false;
      var _loc3_ = 0;
