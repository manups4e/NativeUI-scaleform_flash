class com.rockstargames.gtav.pauseMenu.pauseMenuItems.singleplayer.PauseMenuTextModel extends com.rockstargames.ui.components.GUIModel
{
   ...
   function createView(_viewIndex, _params)
   {
      ...
      if(_loc2_ == undefined)
      {
         _loc2_ = new com.rockstargames.gtav.pauseMenu.pauseMenuItems.singleplayer.PauseMenuTextView();
      }
   ...
   function removeDataFromSlot(_viewIndex, _slotIndex)
   {
      ...
      _loc2_.destroy();
      this.viewIndex = 0;
      var _loc3_ = (com.rockstargames.gtav.pauseMenu.pauseMenuItems.singleplayer.PauseMenuTextView)this.getCurrentView();
   }
}
